<?php
    ...
    function main() {
        ...
        $ventasCliente1 = $objEmpresa->retornarVentasXCliente($objCliente1->getTipoDni(),$objCliente1->getDni());
        echo("Ventas realizadas a ".$objCliente1->__toString().": \n ");
        print_r($ventasCliente1);

        //9.test retornarVentasXCliente
        $ventasCliente2 = $objEmpresa->retornarVentasXCliente($objCliente2->getTipoDni(),$objCliente2->getDni());
